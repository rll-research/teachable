...
def test_success(env, save_dir, finetune_itrs, num_rollouts, teachers, policy_path=None, policy=None,
    ...
    for policy_name in policy_level_names:
        for env in envs:
            test_success(env, save_dir, args.finetune_itrs,
                         args.num_rollouts, args.teachers, policy_path=policy_path.joinpath(policy_name),
