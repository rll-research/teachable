...
try:
    ...
    import d4rl_content.hand_manipulation_suite
    import d4rl_content.pointmaze
    import d4rl_content.gym_minigrid
    import d4rl_content.gym_mujoco
...
try:
    import d4rl_content.gym_bullet
    import d4rl_content.pointmaze_bullet
except ImportError as e:
    if not SUPPRESS_MESSAGES:
...
def reverse_normalized_score(env_name, normalized_score):
    ref_min_score = d4rl_content.infos.REF_MIN_SCORE[env_name]
    ref_max_score = d4rl_content.infos.REF_MAX_SCORE[env_name]
