...
class PreActionAdviceMultipleRepeatedIndex(Teacher):
    def __init__(self, *args, **kwargs):
        self.action_list = [-1] * kwargs['feedback_frequency']
        super(PreActionAdviceMultipleRepeatedIndex, self).__init__(*args, **kwargs)
