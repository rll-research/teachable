...
from meta_mb.algos.sac_torch import SACAgent
...
def configure_logger(args, exp_dir, start_itr, config, is_debug):
...
def run_experiment(**config):
    ...
    configure_logger(args, exp_dir, start_itr, config, is_debug)
