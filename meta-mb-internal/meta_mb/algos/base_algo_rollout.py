...
class BaseAlgoRollout(ABC):
    """The base class for RL algorithms."""

    def __init__(self, envs, acmodel, num_frames_per_proc):
        """
        ...
        example = envs[0].reset()
        self.images = torch.ones(**shape, **example.shape, device=self.device)
