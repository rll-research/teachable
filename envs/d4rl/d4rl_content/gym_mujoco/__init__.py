...
from envs.d4rl.d4rl_content.gym_mujoco import gym_envs
...
for agent in ['hopper', 'halfcheetah', 'ant', 'walker2d']:
    for dataset in ['random', 'medium', 'expert', 'medium-expert', 'medium-replay', 'full-replay']:
        for version in ['v1', 'v2']:
            ...
            register(
                id=env_name,
                entry_point='d4rl_content.gym_mujoco.gym_envs:get_%s_env' % agent.replace('halfcheetah', 'cheetah').replace('walker2d', 'walker'),
...
register(
    id='hopper-medium-v0',
    entry_point='d4rl_content.gym_mujoco.gym_envs:get_hopper_env',
    max_episode_steps=1000,
    kwargs={
...
register(
    ...
    entry_point='d4rl_content.gym_mujoco.gym_envs:get_cheetah_env',
    max_episode_steps=1000,
    kwargs={
...
register(
    ...
    entry_point='d4rl_content.gym_mujoco.gym_envs:get_walker_env',
    max_episode_steps=1000,
    kwargs={
...
register(
    ...
    entry_point='d4rl_content.gym_mujoco.gym_envs:get_ant_env',
    max_episode_steps=1000,
    kwargs={
