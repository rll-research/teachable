...
for agent in ['hammer', 'pen', 'relocate', 'door']:
    for dataset in ['human', 'expert', 'cloned']:
        ...
        register(
            id=env_name,
            entry_point='d4rl_content.hand_manipulation_suite:' + ENV_MAPPING[agent],
...
register(
    id='door-v0',
    entry_point='d4rl_content.hand_manipulation_suite:DoorEnvV0',
...
register(
    id='hammer-v0',
    entry_point='d4rl_content.hand_manipulation_suite:HammerEnvV0',
    max_episode_steps=200,
)
...
register(
    id='pen-v0',
    entry_point='d4rl_content.hand_manipulation_suite:PenEnvV0',
...
register(
    id='relocate-v0',
    entry_point='d4rl_content.hand_manipulation_suite:RelocateEnvV0',
    max_episode_steps=200,
)
